...
fit <- glm(mydata$Restless.Duration..min. ~ 
...
filename2 = paste(filename2, "_2.csv", sep = "")
...
plot(predictedValueArray, myValidateData$Sleep.Duration..hrs., xlab = "Predicted Restless Duration (min)", ylab = "Actual Restless Duration")

filename3 = paste(c("Predicted_Restless_GLM_Student_", i), collapse = "")
filename3 = paste(filename3, ".csv", sep = "")
write.csv(predictedValueArray, file = filename3)

filename4 = paste(c("Actual_Restless_GLM_Student_", i), collapse = "")
